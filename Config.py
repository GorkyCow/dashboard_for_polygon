...
class Config:
    ...
    @staticmethod
    def load_from_yml(conf_file: str = 'config.yml', db_conf_file: str = 'postgres_conf.yml'):
        try:
        ...
        try:
            ...
            raise Exception("Config file incorrect. Check postgres_conf.yml.dist for example.")
        new_config.validate()
        return new_config
